...
public class tampilan extends javax.swing.JFrame {
    ...
    public tampilan(String nama,String lahir,String kota,String no,String tgl, String bln, String thn, String ktg, String agama, String jk, String lomba) {
        initComponents();
        tampil.setText("Nama\t\t: "+nama+"\nTanggal Lahir\t\t: "+tgl +bln +thn+ "\nTempat Lahir\t\t: "+lahir+ "\nKota Asal\t\t: "+kota+ "\nAgama\t\t: "+agama+ "\nJenis Kelamin\t\t: "+jk+ "\nJenis Lomba\t\t: "+lomba+ "\nKategori\t\t: "+ktg);
    }

    tampilan(String nama, String lahir, String kota, String no, String tgl, String bln, String thn, String ktg, String agama, String jk) {
